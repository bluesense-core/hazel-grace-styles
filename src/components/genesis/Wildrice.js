...
const Wildrice = ({ formatter }) => {
    const data = genesisData.filter((e) => e.alt === 'Wildrice Dress')[0];
                ...
                <Row className='align-items-center py-3 gy-lg-0 gy-5'>
                    ...
                    <Col
                        ...
                        <Form onSubmit={(e) => e.preventDefault()}>
                            <Form.Label className='fs-6 mb-2'>Size:</Form.Label>
                            <div
                                key='inline-radio'
                            ...
                            <FormGroup className='mx-lg-0 mx-auto details-qty mb-5 d-flex align-items-center justify-space-between'>
                                <button
                                    ...
                                    type='button'
                                    disabled={
                                        formData.quantity === 1 ? true : false
                                    }
                                    onClick={() =>
